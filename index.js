...
const authConfig = {
  ...
  **************************************************/
   ...
   **************************************************/
    ...
    **************************************************/
    {
      id: "id_1", // Fill this with a drive id (personal or team drive) or a folder id.
      name: "Name 1",
      user: '',
      pass: "",
    ...
    /**************************************************
    {
      id: "id_2", // Fill this with a drive id (personal or team drive) or a folder id.
      name: "Name 2",
      user: '',
      pass: "",
      protect_file_link: false // Set this to "true" to enable the Basic HTTP Authentication.
    ...
    {
      id: "id_3", // Fill this with a drive id (personal or team drive) or a folder id.
      name: "Name 3",
      user: '',
      pass: "",
      protect_file_link: false // Set this to "true" to enable the Basic HTTP Authentication.
